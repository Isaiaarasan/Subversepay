        ...
        <div className="flex-1 max-w-xl">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-gray-50/50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm text-gray-700 placeholder:text-gray-400"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 ml-8">
          ...
          <div className="flex items-center gap-2 border-r border-gray-200 pr-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="p-2.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-colors relative"
            >
              <Filter size={20} />
            </motion.button>
            <motion.button
